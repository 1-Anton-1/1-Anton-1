...
| - |:------------------------------------------------------------------------------------------------------------------------------------------------------------- |:---------------------------------:| ---------------------------------------------------- |
| 1 | [Titanic]([https://github.com/Danspers/Matching](https://github.com/1-Anton-1/PROJECTS/tree/main/DS/1.%20Titanic%20-%20Machine%20Learning%20from%20Disaster))| `Pandas`, `Scikit-Learn` | Деревья решений |
| 2 | [Fishki-CV]([https://github.com/Danspers/Fishki-CV](https://github.com/1-Anton-1/PROJECTS/tree/main/DS/2.%20Digit%20Recognizer/Gradient_Descent))| `Pandas`, `Gradient_Descent` | Обучение нейросети методом грданиентного спуска.      |
